...
function Hero() {
  return (
    <div className="bg-black h-screen grid grid-cols-2 gap-2 items-center" id="home">
      <div>
        <h4 className="font-medium leading-tight text-5xl mt-0 mb-2 text-white ml-10 mt-8">
          A platform to help you curate and showcase the{" "}
          <a
            style={{
              color: "linear-gradient(to right, #C333F8 , #1BC5E2)",
              WebkitTextFillColor: "transparent",
              WebkitBackgroundClip: "text",
            }}
            className="text-black-600 font-bold bg-gradient-to-r from-pink to-blue"
          >
            links
          </a>{" "}
          you've been sharing.
        </h4>
        <p className="text-white ml-10 mt-8 text-dark-gray">
          ...
          amet, consectetur adipiscing elit. Iaculis mauris neque sit turpis est
          mi sit in massa.{" "}
        </p>
        <div className="flex items-center">
          <div className="bg-gray flex items-center ml-8 mr-15 w-2/4 p-6 mt-5 rounded-3xl">
            ...
            <button className="bg-purple text-sm px-4 py-2 leading-none border rounded text-white border-purple  mt-4 lg:mt-0 mr-7 flex-auto w-32 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-pink">
              Get Started
            </button>
          </div>
          <div className="flex items-center mt-5">
            ...
            <p className="text-white border-y-0 ml-2 underline">
              Why Bitsy.bio?
            </p>
          </div>
        </div>
        <div className="flex mt-8 ml-6 items-center">
          ...
          <p className="text-dark-gray ml-2 ">Trusted By over<a className="text-purple">  200K+ </a> creators</p>
        </div>
      </div>
      ...
      <div className="mx-15 mt-8 px-5 ml-10">
        <div className="flex ">
          <div
            className="bg-yellow border rounded-full w-15 p-12 absolute top-[calc(100%-28rem)] animate-pulse "
